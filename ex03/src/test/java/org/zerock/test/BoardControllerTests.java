...
//		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "1").param("title", "수정된 테스트 새글 제목").param("content", "수정된 테스트 새글 제목").param("writer", "user00")).andReturn().getModelAndView().getViewName();
//
//		log.info(resultPage);
//	}
//	@Test
